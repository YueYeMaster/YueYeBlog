...
const articles = {
  ...
  knowledge: `
    <div class="article">
      ...
      <!-- 知识分享内容 -->
      <p class="content-text"> 在竞赛中 运行时间是非常重要的参数 c++中 输入输出都可以加速 400ms 加速后可以到达20ms 接近20倍的效率  输入优化 在main输入中 ios::sync_with_stdio(false);   cin.tie(nullptr);  这是输入的优化</p>
...
则减去(3.3)到(0.0)的最短路径数量 再减去(4,6)到(3,3)的最短路径数量 即可</p>
  ...
  diary: `
    <div class="article">
      ...
      <!-- diary内容 -->
      <p class="content-text">2025.11.30 00:17 也是回家了 感觉很祥和的感觉 准备备战竞赛 下周还要去实习面试 还有期末考试 好吧 其实我还蛮享受这样很忙碌的感觉 元旦还要和哥们出去玩 实话 满期待的 很久没有这么目标明确过了 hhh 现在我确实可以来进行知识分享了 还有什么校内的软件赛 问题不大            缅怀我的外公 不过也好 走到时候很平静 没有收太多 病痛 也许我有一天也这样离去了呢 所有我要写一封遗书 当然有点不吉利 不过 我不太在意这些 问题不大 作为一个超级恋旧的人 希望可以给世界留下一些东西 代表我来过 hhh 我还是太豁达了 问题不大 动力满满ing</p>
      <p class="content-text">2025.11.26 16:11 我怀念的是无话不说 我怀念的是争吵以后 还是想要爱你的冲动 我怀念的是绝对炙热 记得感觉汹涌 谁忘了那就是承诺 谁自顾自地走 谁忘了要给你温柔 太爱了 所以我 没有哭 没有说 为了校赛强行Java转c 虽然其实都差不多 下周就要实习了 感觉应该会是很美好的体验 期待 这和互相诈骗有什么区别 hhhh 多写诗 多写代码 okkkkkkkk 实在不行干男模吧 万一呢~ 万一呢~</p>
